...
<body>
  ...
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" >
      ...
      <label for="health_preference"> Any health preferences?</label>
      <select name="health_preference" id="health_preference" required>
        ...
        <!-- Add more options based on your project -->
      </select>
...
$diseases= mysqli_real_escape_string($con ,$_POST['health_preference']);
   ...
   if(mysqli_num_rows($result) > 0){
    ...
    echo '<script>alert("Email Alredy Exists");</script>';
      ...
      if($pass != $cpass)
      {
        ...
        $insert=mysqli_query($con, "INSERT INTO `formtest` SET uname = '$name',image = '$fName', email = '$email', phone='$number',pass = '$pass',diseases='$diseases'" );
